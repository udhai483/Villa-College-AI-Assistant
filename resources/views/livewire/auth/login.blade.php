<div x-data="{ darkMode: @js($darkMode) }" 
    ...
    <div class="max-w-6xl w-full space-y-8 relative z-10">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-3xl mx-auto">
            <div class="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-sm hover:shadow-lg transition-all duration-300 border border-gray-100 dark:border-gray-700 h-full">
                <div class="flex items-start gap-4 h-full">
                    <div class="flex-shrink-0">
                        <div class="w-12 h-12 bg-primary-600/10 dark:bg-primary-500/10 rounded-full flex items-center justify-center">
